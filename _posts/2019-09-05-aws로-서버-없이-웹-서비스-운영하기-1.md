...
<caption id="attachment\_1091" align="aligncenter" width="1864">[![]({{ site.baseurl }}/images/NdANMMniAO.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-03-오후-3.11.39.png) 리멤버 서비스에서 실제로 사용중인 t2.medium 2대 기준 24시간 한달 비용 $89.02 (트래픽 증가시 +a 금액 있음)</caption>

<caption id="attachment\_1093" align="aligncenter" width="2540">[![]{{ site.baseurl }}/images/KJ3RtHh7J3.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-03-오후-3.17.44.png) S3 1G 적재 및 100만 request, CloudFront 월 1G Data transfer 기준 (Lambda@Edge는 포함하지 않음)</caption>
...
<caption id="attachment\_1097" align="aligncenter" width="584">[![]{{ site.baseurl }}/images/gukd2XsgIt.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/Career-web_Infra_1.png) 예제를 통해 완성될 인프라 구조</caption>
...
[![]{{ site.baseurl }}/images/G0Qdra6VmX.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-5.16.43.png)
...
<caption id="attachment\_1100" align="aligncenter" width="3154">[![]({{ site.baseurl }}/images/EjhhxyOGPk.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-5.28.23.png) yarn build를 통해 build된 파일들을 S3에 업로드한 모습</caption>
...
[![]{{ site.baseurl }}/images/WL1xyABVOP.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-5.33.59.png)

저희는 Web을 배포할 것이기 때문에 Web의 Get Started를 눌러 다음 단계로 넘어가 주세요.

### Origin Settings

[![]{{ site.baseurl }}/images/UcM8THzwkx.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-5.36.18.png)
...
[![]{{ site.baseurl }}/images/F5YvujCF3U.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-5.36.49.png)
...
### Distribution Setting[![]{{ site.baseurl }}/images/6EjjjZJHIj.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-6.23.30.png)
...
[![]{{ site.baseurl }}/images/3KUnNp4S2Y.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-7.55.17.png)
...
<caption id="attachment\_1109" align="aligncenter" width="2996">[![]{{ site.baseurl }}/images/qBB7gs9KVH.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-8.01.12.png) /test로 접근시 에러가 나는 모습</caption>
...
<caption id="attachment\_1110" align="aligncenter" width="2584">[![]{{ site.baseurl }}/images/JUngAT25Bd.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-8.07.06.png) Error Pages 탭</caption>

Create Custom Error Response를 클릭하여

[![]({{ site.baseurl }}/images/rqNzVtFLwo.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-8.08.25.png)

다음과 같이 설정 후에 Create를 눌러줍니다. 반영되는 시간이 조금 걸리니 일정 시간이 흐른 후 /test에 다시 접근해 보도록 합시다.

<caption id="attachment\_1112" align="aligncenter" width="646">[![]{{ site.baseurl }}/images/MtMBJKAl5A.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-8.17.02.png) /test path에 제대로 접근 된 모습</caption>
...
[![]{{ site.baseurl }}/images/vSCfjslK5i.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-8.26.19.png)

Route53 설정까지 완료됐다면 해당 Domain으로 접근했을 때 성공적으로 Web이 뜨고 자물쇠 모양도 잘 보인다면 성공입니다!

<caption id="attachment\_1115" align="aligncenter" width="646">[![]{{ site.baseurl }}/images/DjhOCh5AQo.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-02-오후-7.38.44.png) 성공적으로 Domain에 연결 된 모습</caption>
