...
[![]({{ site.baseurl }}/images/GzhoDQJujI.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-03-오후-5.19.08.png)
...
[![]{{ site.baseurl }}/images/zkeKvoMZv8.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-05-오전-11.51.24.png)
...
[![]{{ site.baseurl }}/images/Vd7jzBt1s1.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-04-오후-5.31.00-1.png)

Appium의 처음 실행화면입니다. Host와 Port를 직접 구성하여 쓸 수 있는데, 동일한 Host를 구성하여 Appium을 열어주었다면 실행이 불가능해질 수 있으므로 잘 체크하도록 합시다.

[![]{{ site.baseurl }}/images/WmZpqY7JbP.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-04-오후-5.31.06-2.png)

Appium이 정상적으로 실행된 모습입니다. 상단 '돋보기' 모양의 버튼을 눌러 Starter inspector Session 설정창을 띄워줍니다.

[![]{{ site.baseurl }}/images/sk1KHzrwZi.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-04-오후-5.32.06-1.png)
...
[![]{{ site.baseurl }}/images/zohm1qk2yw.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-04-오후-5.36.40-1.png)
...
[![]{{ site.baseurl }}/images/dJgwhMEb8T.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/Elipse-프로젝트-생성-화면.png)

해당 화면에서 \[File\] > \[New\] > \[Maven Project\] 메뉴를 선택해 줍니다.

[![]{{ site.baseurl }}/images/3R50omdXTv.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-05-오전-10.24.12.png)

New Maven Project창에서 Next를 누르다가 해당 화면이 나오면 Group ID, artifact Id를 입력하고 \[Finish\] 버튼을 눌러줍시다.

[![]({{ site.baseurl }}/images/MfpHPhSISt.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-05-오전-11.01.40.png)
...
[![]{{ site.baseurl }}/images/p0kpm99MLu.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-05-오전-11.20.38.png)

이렇게 생성된 클래스에서 실제 개발을 진행하게 되는데, 해당 바디는 크게 **선처리, 후처리, 테스트 동작 메소드를** 구성하게 됩니다. (해당 포스팅에서는 '선처리' 부분까지만 다루겠습니다.)

[![]{{ site.baseurl }}/images/Zoaybc4gYr.png)](https://blog.dramancompany.com/wp-content/uploads/2019/09/스크린샷-2019-09-05-오전-11.25.52.png)
