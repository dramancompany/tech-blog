...
<caption id="attachment\_763" align="aligncenter" width="291">[![]{{ site.baseurl }}/images/poYY31JeYv.png)](https://blog.dramancompany.com/wp-content/uploads/2017/03/스크린샷-2017-03-23-오전-11.03.06.png) Gson Annotation을 이용하여 하나의 모델로 API 응답을 받아온다.</caption>
...
<caption id="attachment\_762" align="aligncenter" width="509">[![]{{ site.baseurl }}/images/Ivlgn9tBVG.png)](https://blog.dramancompany.com/wp-content/uploads/2017/03/스크린샷-2017-03-23-오전-11.02.49.png) ORM을 이용하여 DB 스키마와 같은 모델을 그대로 비즈니스 모델로 사용한다.</caption>
...
<caption id="attachment\_764" align="aligncenter" width="502">[![]{{ site.baseurl }}/images/E3852OBrLO.png)](https://blog.dramancompany.com/wp-content/uploads/2017/03/스크린샷-2017-03-23-오전-11.04.14.png) API 응답은 이제 Mapper를 이용해 받아온다.</caption>
...
<caption id="attachment\_765" align="aligncenter" width="507">[![]{{ site.baseurl }}/images/TYrHuw3VLr.png)](https://blog.dramancompany.com/wp-content/uploads/2017/03/스크린샷-2017-03-23-오전-11.04.29.png) DB 스키마와 비즈니스 모델이 분리되었다. Mapper를 이용하여 서로 변환한다.</caption>
