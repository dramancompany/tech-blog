...
![](/assets/post/images/그림-1.-다양한-환경-및-촬영-상황.png)
...
![](/assets/post/images/그림-2.-Task의-결과.png)
...
![](/assets/post/images/그림-3-AI-명함-촬영-인식-모델의-파이프-라인.png)

그림 3 AI 명함 촬영 인식 모델의 파이프 라인

## **RIO Detector(Object Detection)**

![](/assets/post/images/그림-4.-RIO-Detector-적용된-리멤버-앱-min.gif)
...
![](/assets/post/images/그림-5.-이진화된-명함의-영역세그멘테이션-결과.png). ![](/assets/post/images/그림-6.-원본-이미지와-세그멘테이션-매핑예상-결과.png)
...
![](/assets/post/images/그림-6.-명함이미지의-외각선-검출-예시.png)
...
![](/assets/post/images/그림-7.-minAreaRect-결과-이미지.png)
...
![](/assets/post/images/그림-8.-최소거리-포인트-검출-방법.png)
...
![](/assets/post/images/그림-9.-명함-이미지의-투영-변환-예시.png)
