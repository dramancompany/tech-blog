...
<caption id="attachment\_488" align="aligncenter" width="470">[![realmDark](/images/BSSvMJ6o14.jpg)](https://blog.dramancompany.com/wp-content/uploads/2016/03/realmDark.jpg) 안드로이드에 기본적으로 설치된 Sqlite 기반으로 다양한 ORM이 있습니다. Realm은 엔진부터 새로 만든 데이터베이스 입니다. 그래서 Sqlite보다 빠르면서도, ORM과 같은 기능이 자연스럽게 제공되어 다루기 편합니다.</caption>
...
[![스크린샷 2016-03-14 오후 4.45.04](/images/스크린샷-2016-03-14-오후-4.45.04.png)](https://blog.dramancompany.com/wp-content/uploads/2016/03/스크린샷-2016-03-14-오후-4.45.04.png) [![스크린샷 2016-03-14 오후 7.57.59](/images/스크린샷-2016-03-14-오후-7.57.59.png)](https://blog.dramancompany.com/wp-content/uploads/2016/03/스크린샷-2016-03-14-오후-7.57.59.png)
...
<caption id="attachment\_536" align="aligncenter" width="506">[![다른 쓰레드에서 따로 접근하여도, 같은 Realm DB 객체라면, 하나의 인스턴스를 참조합니다. 따라서 하나의 쓰레드에서 Realm 객체를 삭제한다면, 다른 쓰레드에서 접근하지 못합니다.](/images/스크린샷-2016-03-14-오후-5.58.08.png)](https://blog.dramancompany.com/wp-content/uploads/2016/03/스크린샷-2016-03-14-오후-5.58.08.png) 다른 쓰레드에서 따로 접근하여도, 같은 Realm DB 객체라면, 하나의 인스턴스를 참조합니다. 따라서 하나의 쓰레드에서 Realm 객체를 삭제한다면, 다른 쓰레드에서 접근하지 못합니다.</caption>
