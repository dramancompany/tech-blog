...
<caption id="attachment\_250" align="aligncenter" width="211">[![6.0 부터는 사용자가 설정창에서 권한그룹 단위로 허용/거부를 명시적으로 할 수 있습니다.](/images/권한그룹-설정창-169x300.jpeg)](https://blog.dramancompany.com/wp-content/uploads/2015/11/권한그룹-설정창.jpeg) M버전 부터는 사용자가 설정창에서 권한그룹 단위로 허용/거부를 명시적으로 할 수 있습니다.</caption>
...
<caption id="attachment\_251" align="aligncenter" width="226">[![system_window_alter는 다른 권한들과 다르게 '다른 앱 위에 그리기' 설정창에서 직접 허용받아야 합니다.](/images/다른앱-위에-그리기-169x300.jpeg)](https://blog.dramancompany.com/wp-content/uploads/2015/11/다른앱-위에-그리기.jpeg) system\_window\_alert는 다른 권한들과 다르게 '다른 앱 위에 그리기' 설정창에서 직접 허용받아야 합니다.</caption>
...
<caption id="attachment\_234" align="aligncenter" width="233">[![스택창에서 설정을 끄고 다시 돌아가면 Activity가 재생성된다.](/images/스택창-169x300.jpeg)](https://blog.dramancompany.com/wp-content/uploads/2015/11/스택창.jpeg) 스택창에서 설정을 끄고 돌아가면 Activity가 재생성 됩니다. 이 현상은 테스트를 적지 않게 방해합니다.</caption>
