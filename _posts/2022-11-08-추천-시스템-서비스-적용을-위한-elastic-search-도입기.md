...
![](/assets/post/images/그림_1_커뮤니티메인.png)
...
![](/assets/post/images/그림_2_콘텐츠기반추천예시.png)
...
![](/assets/post/images/그림_3_SimCSE예시.png)
...
![](/assets/post/images/그림_5_유저임배딩생성.png)

## 3-3. 전체 추천 로직

전체적인 추천 로직을 정리해보자면, 유저 임베딩과 유저가 참여중인 커뮤니티의 콘텐츠들과 유사도를 비교하여 가장 유사한 top K개를 추천해주는 로직 입니다.

![](/assets/post/images/그림_6_전체추천로직.png)
...
- 변경 전 방법  
    ![](/assets/post/images/그림_7_몽고DB활용.png)
...
![](/assets/post/images/그림_8_knn예시.png)

##### HNSW (Hierarchical Navigable Small World Algorithm)

![](/assets/post/images/그림_9_HSWM.png)
...
- 변경 후 방법  
    ![](/assets/post/images/그림_10_opensearch활용예시.png)
...
![](/assets/post/images/스크린샷-2022-11-07-오후-10.13.47.png)
...
![](/assets/post/images/스크린샷-2022-11-08-오후-1.57.38.png)
